================================================================================
    MICROSOFT 基础类库： BigStashAssistant 项目概述
===============================================================================

应用程序向导已为您创建了此 BigStashAssistant 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 BigStashAssistant 应用程序的每个文件的内容摘要。

BigStashAssistant.vcproj
...
BigStashAssistant.h
    ...
    CBigStashAssistantApp 应用程序类。

BigStashAssistant.cpp
    这是包含应用程序
    类 CBigStashAssistantApp 的主应用程序源文件。

BigStashAssistant.rc
    这是程序使用的所有 Microsoft Windows 资源
    的列表。  它包含存储在 RES 子目录中
    的图标、位图和光标。  可直接在 Microsoft 
    Visual C++ 中编辑此文件。 项目资源包含在 2052 中。

res\BigStashAssistant.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 BigStashAssistant.rc 中。

res\BigStashAssistant.rc2
    此文件包含不由 Microsoft 
...
应用程序向导将创建一个对话框类：
BigStashAssistantDlg.h、BigStashAssistantDlg.cpp - 对话框
    这些文件包含 CBigStashAssistantDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    BigStashAssistant.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 BigStashAssistant.pch 的预编译头文件 (PCH)
